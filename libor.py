...
# %%
xyz_interp, R_ned2b_interp, R_ned2e_interp = trajectory.interpolate(lasvec[:,0])
...
xyz_interp_a, R_ned2b_interp_a, R_ned2e_interp_a = trajectory.interpolate(corres[:,1])
xyz_interp_b, R_ned2b_interp_b, R_ned2e_interp_b = trajectory.interpolate(corres[:,0])
...
# %% do same with icp
xyz_interp_a, R_ned2b_interp_a, R_ned2e_interp_a = trajectory.interpolate(corres_icp[:,1])
xyz_interp_b, R_ned2b_interp_b, R_ned2e_interp_b = trajectory.interpolate(corres_icp[:,0])
